...
import { Server, Box, Lock, Search, Key, Database } from 'lucide-react';
    ...
    <div className="flex items-center justify-between w-full max-w-lg gap-4 relative py-4">
        ...
        <div className="flex flex-col gap-3 z-10 bg-slate-900 p-3 rounded-lg border border-slate-700 shadow-lg">
            <div className="flex items-center gap-3">
                 <div className="w-8 h-8 bg-slate-800 border border-green-500/50 rounded flex items-center justify-center shadow-[0_0_10px_rgba(34,197,94,0.1)]">
                    <span className="text-xs font-mono text-green-400 font-bold">21</span>
                 </div>
                 <span className="text-xs text-slate-300 font-medium">FTP (Open)</span>
            </div>
...
export const ExploitDiagram = () => (
    <div className="w-full p-6 bg-slate-950/50 rounded-lg border border-slate-800 flex flex-col items-center gap-4 mt-6">
      <div className="text-xs text-slate-500 uppercase tracking-widest font-semibold">Exploiting a Backdoor</div>
      <div className="flex flex-col md:flex-row items-center w-full max-w-xl justify-center gap-6 md:gap-8 relative">
        ...
        <div className="flex flex-col items-center group relative z-10">
            ...
            <span className="text-xs text-center text-purple-300 font-bold">Metasploit<br/>Payload</span>
        </div>
        ...
        <div className="flex flex-col items-center group relative z-10">
            ...
            <span className="text-xs text-center text-orange-300 font-bold">Vulnerable<br/>Backdoor</span>
        </div>
        ...
        <div className="flex flex-col items-center group relative z-10">
            ...
            <span className="text-xs text-center text-green-300 font-bold">Root<br/>Access</span>
        </div>
      </div>
    </div>
);